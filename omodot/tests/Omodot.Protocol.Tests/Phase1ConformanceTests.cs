...
public sealed class Phase1ConformanceTests
{
    ...
    public async Task Phase1_Initialize_WithInvalidVersion_ReturnsVersionMismatch()
    {
        ...
        AssertJsonEqual(LoadNode(".omo/evidence/task-11-omodot-version-mismatch.json"), response);
    }
    ...
    public async Task Phase1_RunDispatch_ProducesProgressAndResult_AndMatchesGoldenShape()
    {
        ...
        AssertJsonEqual(LoadNode(".omo/evidence/task-11-omodot-phase1-success.json"), transcript);

        AssertJsonEqual(LoadNode("protocol-fixtures/golden/omodot-phase1-success.json"), transcript);
