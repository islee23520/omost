using Omodot.BoulderState;
using Omodot.BoulderState.Storage;

namespace Omodot.BoulderState.Tests;

public sealed class BoulderStateTests : IDisposable
{
    private readonly string _tempDirectory = Path.Combine(Path.GetTempPath(), $"omodot-boulder-state-{Guid.NewGuid():N}");
