...
internal static class Program
{
    ...
    {
        Console.Error.WriteLine("Usage: omodot <command> [options]");
    ...
    {
        Console.WriteLine("omodot 0.1.0");
        return 0;
    }
    ...
    private static async Task<int> RunMcpServerAsync()
    {
        ...
        {
            await Console.Error.WriteLineAsync($"omodot codex mcp bridge terminated: {exception}").ConfigureAwait(false);
    ...
    private static int RunHook(string? hookEvent)
    {
        ...
        {
            Console.Error.WriteLine("Usage: omodot hook <event>");
    ...
    private static int RunInitPlugin(string[] args)
    {
        ...
        outputPath ??= Path.Combine(
            ...
            ".codex", "local-marketplaces", "omodot-local");
