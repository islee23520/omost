...
public static class TmuxUtils
{
    ...
    public static Task<int> SweepStaleLfeAgentSessionsWithAsync(SweepDependencies dependencies, CancellationToken cancellationToken = default) => StaleSessionSweep.SweepStaleLfeAgentSessionsWithAsync(dependencies, cancellationToken);
    public static Task<int> SweepStaleLfeAgentSessionsAsync(CancellationToken cancellationToken = default) => StaleSessionSweep.SweepStaleLfeAgentSessionsAsync(cancellationToken);
